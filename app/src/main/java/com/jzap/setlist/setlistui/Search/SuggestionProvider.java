...
public class SuggestionProvider extends ContentProvider {
    ...
    private static final String TAG = Config.TAG_HEADER + "SuggestionProvider";

    //public static String AUTHORITY = "com.example.android.searchabledict.DictionaryProvider";
    public static String AUTHORITY = "com.jzap.setlist.setlistui.Search.SuggestionProvider";
    ...
    private SetListFmArtistsDB mDictionary;
    ...
    public boolean onCreate() {
        Log.i(TAG, "Created");
        mDictionary = new SetListFmArtistsDB(getContext());
        return true;
    }
    ...
    private Cursor getSuggestions(String query) {
        ...
        String[] columns = new String[] {
                BaseColumns._ID,
                SetListFmArtistsDB.KEY_WORD,
                SetListFmArtistsDB.KEY_DEFINITION,
